...
int parse(std::string project_input_file_name,
    ...
    std::cout << "parser meta data...\n";
    std::cout << "project_input_file_name: " <<  project_input_file_name << "\n";
    std::cout << "source_include_file_name: " <<  source_include_file_name << "\n";
    std::cout << "include_path: " <<  include_path << "\n";
    std::cout << "sys_include: " <<  sys_include << "\n";
    std::cout << "module_name: " <<  module_name << "\n";
    std::cout << "show_errors: " <<  show_errors << "\n";
