...
#define TypeMetaDef(class_name, ptr) \
    Pupil::Reflection::ReflectionInstance(Pupil::Reflection::TypeMeta::newMetaFromName(#class_name), \
                                            (class_name*)ptr)

#define TypeMetaDefPtr(class_name, ptr) \
    new Pupil::Reflection::ReflectionInstance(Pupil::Reflection::TypeMeta::newMetaFromName(#class_name), \
                                                (class_name*)ptr)
